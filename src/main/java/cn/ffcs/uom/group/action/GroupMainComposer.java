...
import cn.ffcs.uom.group.action.bean.GroupMainBean;
...
@Controller
@Scope("prototype")
public class GroupMainComposer extends BasePortletComposer implements
		IPortletInfoProvider {

	private static final long serialVersionUID = 1L;

	private GroupMainBean bean = new GroupMainBean();
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		bean.getGroupListboxExt().setVariablePagePosition("groupPage");
	}
	...
	private void initPage() throws Exception {
		this.bean.getStaffListboxExt().setPagePosition("groupPage");
		this.bean.getGroupListboxExt().setPagePosition("groupPage");
	}
}
