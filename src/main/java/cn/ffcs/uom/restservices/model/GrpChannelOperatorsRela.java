...
public class GrpChannelOperatorsRela extends UomEntity implements Serializable {

	/**
	 * 渠道经营主体关系标识
	 */
	@XmlTransient
	public Long getGrpChannelOperatorsRelaId() {
		return super.getId();
	}

	public void setGrpChannelOperatorsRelaId(Long grpChannelOperatorsRelaId) {
		super.setId(grpChannelOperatorsRelaId);
	}
	...
	public String getRelaTypeName() {
		List<AttrValue> list = UomClassProvider.jdbcGetAttrValueByValue(
				"GrpChannelOperatorsRela", "relaType", this.getRelaType(),
