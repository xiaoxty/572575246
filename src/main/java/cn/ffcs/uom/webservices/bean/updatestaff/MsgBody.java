...
public class MsgBody implements java.io.Serializable {
     ...
     * 请求参数
     */
    private cn.ffcs.uom.webservices.bean.updatestaff.InParam _inParam;

    /**
     * 返回参数
     */
    private cn.ffcs.uom.webservices.bean.updatestaff.OutParam _outParam;
     ...
     */
    public cn.ffcs.uom.webservices.bean.updatestaff.InParam getInParam(
    ) {
     ...
     */
    public cn.ffcs.uom.webservices.bean.updatestaff.OutParam getOutParam(
    ) {
    ...
    public void setInParam(
            final cn.ffcs.uom.webservices.bean.updatestaff.InParam inParam) {
    ...
    public void setOutParam(
            final cn.ffcs.uom.webservices.bean.updatestaff.OutParam outParam) {
