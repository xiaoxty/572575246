...
public class MsgBody implements java.io.Serializable {
     ...
     * 请求参数
     */
    private cn.ffcs.uom.webservices.bean.ftpinform.InParam _inParam;

    /**
     * 返回参数
     */
    private cn.ffcs.uom.webservices.bean.ftpinform.OutParam _outParam;
     ...
     */
    public cn.ffcs.uom.webservices.bean.ftpinform.InParam getInParam(
    ) {
     ...
     */
    public cn.ffcs.uom.webservices.bean.ftpinform.OutParam getOutParam(
    ) {
    ...
    public void setInParam(
            final cn.ffcs.uom.webservices.bean.ftpinform.InParam inParam) {
    ...
    public void setOutParam(
            final cn.ffcs.uom.webservices.bean.ftpinform.OutParam outParam) {
