...
public class OutParam implements java.io.Serializable {
     ...
     * 错误信息
     */
    private cn.ffcs.uom.webservices.bean.updatestaff.Error _error;
     ...
     */
    public cn.ffcs.uom.webservices.bean.updatestaff.Error getError(
    ) {
        return this._error;
    }
    ...
    public void setError(
            final cn.ffcs.uom.webservices.bean.updatestaff.Error error) {
        this._error = error;
    }
