...
public class Root implements java.io.Serializable {
     ...
     * Field _msgBody.
     */
    private cn.ffcs.uom.webservices.bean.ftpinform.MsgBody _msgBody;
     ...
     */
    public cn.ffcs.uom.webservices.bean.ftpinform.MsgBody getMsgBody(
    ) {
    ...
    public void setMsgBody(
            final cn.ffcs.uom.webservices.bean.ftpinform.MsgBody msgBody) {
