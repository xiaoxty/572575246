...
import cn.ffcs.uom.gridUnit.action.bean.GridSeventeenUnitTreeMainBean;
...
@Controller
@Scope("prototype")
public class GridSeventeenUnitTreeMainComposer extends BasePortletComposer implements
     ...
     * 页面bean
     */
    private GridSeventeenUnitTreeMainBean bean = new GridSeventeenUnitTreeMainBean();
    /**
     * 选中的组织
     */
