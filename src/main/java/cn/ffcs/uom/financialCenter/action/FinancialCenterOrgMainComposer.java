package cn.ffcs.uom.financialCenter.action;
...
import cn.ffcs.uom.financialCenter.action.bean.FinancialCenterOrgMainBean;
...
@Controller
@Scope("prototype")
public class FinancialCenterOrgMainComposer extends BasePortletComposer
	 ...
	 * bean.
	 */
	private FinancialCenterOrgMainBean bean = new FinancialCenterOrgMainBean();
	/**
	 * 选中的组织
	 */
	...
	public void callTab() throws Exception {
		...
		if (organization != null && organization.getOrgId() != null) {
			...
			/*
			 * if
			 * ("staffOrganizationTab".equals(this.bean.getSelectTab().getId()))
			 ...
			 * bean.getStaffOrganizationListbox(), staffOrganization); } if
			 * ("organizationPositionTab".equals(this.bean.getSelectTab()
			 * .getId())) { Events.postEvent(
	...
	private void initPage() throws Exception {
		this.bean.getOrganizationListbox().setPagePosition("financialCenterPage");
		this.bean.getOrganizationRelationListbox().setPagePosition(
				"financialCenterPage");
		// this.bean.getStaffOrganizationListbox().setPagePosition("financialCenterPage");
		// this.bean.getOrganizationPositionExt().setPagePosition("financialCenterPage");
	}
}
