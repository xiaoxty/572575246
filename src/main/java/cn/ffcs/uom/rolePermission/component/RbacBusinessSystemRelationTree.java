...
public class RbacBusinessSystemRelationTree extends Tree implements IdSpace {
	 ...
	 * 构造函数.
	 */
	public RbacBusinessSystemRelationTree() {
	...
	public void bindTree() {
		...
		rbacBusinessSystemRelation.setIsRoot(true);
		final TreeNodeImpl<RbacBusinessSystemRelation> treeNode = new TreeNodeImpl<RbacBusinessSystemRelation>(
