...
public class NewSeventeenMarketingTreeExt extends Div implements IdSpace {

	/**
	 * .
	 */
	private static final long serialVersionUID = 362370600371214468L;
	/**
	 * zul文件路径。
	 */
	private final String zul = "/pages/organization/new_seventeen_marketing_tree_ext.zul";
	/**
	 * 组织树
	 */
	...
	public NewSeventeenMarketingTreeExt() {
		 ...
		 * 组织名称修改要改组织树节点名称
		 */
		NewSeventeenMarketingTreeExt.this.addForward(
				OrganizationConstant.ON_SAVE_ORGANIZATION_INFO,
				NewSeventeenMarketingTreeExt.this,
				"onSaveOrganiazationInfoResponse");
	...
	public void onAddRootNode() throws Exception {
		...
		String opType = "addNewSeventeenMarketingRootNode";
	...
	public void onAddChildNode() throws Exception {
		...
		if (this.organizationRelationTree.getSelectedItem() != null) {
			String opType = "addNewSeventeenMarketingChildNode";
			this.openAddNodeWindow(opType);
		} else {
	...
	private void openAddNodeWindow(String opType) throws Exception {
		...
		win.addEventListener("onOK", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				if (map.get("opType")
						.equals("addNewSeventeenMarketingRootNode")) {
					onAddRootNodeResponse(organizationRelation);
				} else if (map.get("opType").equals(
						"addNewSeventeenMarketingChildNode")) {
				...
				public void onEvent(Event event) throws Exception {
					if (event.getData() != null) {
						...
						Events.postEvent(OrganizationConstant.ON_DEL_NODE_OK,
								NewSeventeenMarketingTreeExt.this, null);
	...
	public void onSelect$organizationRelationTree() throws Exception {
		...
		// 组织树层级控制
		// this.setPagePosition("NewSeventeenMarketingTreePage");
	...
	public void setPagePosition(String page) throws Exception {
		...
		} else if ("newSeventeenMarketingTreePage".equals(page)) {
