...
import cn.ffcs.uom.organization.component.CostTreeExt;
...
public class OrganizationCostTreeMainBean {
	/**
	 * tabBox
	 */
	@Getter
	...
	@Getter
	@Setter
	private CostTreeExt costTreeExt;
	/**
	 * EDW树
	 */
	@Getter
