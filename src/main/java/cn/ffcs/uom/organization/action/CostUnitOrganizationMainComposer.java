...
import cn.ffcs.uom.organization.action.bean.CostUnitOrganizationMainBean;
...
@Controller
@Scope("prototype")
public class CostUnitOrganizationMainComposer extends BasePortletComposer implements IPortletInfoProvider{
	/**
	 * 
	 */
	 ...
	 * bean.
	 */
	private CostUnitOrganizationMainBean bean = new CostUnitOrganizationMainBean();
	/**
	 * 选中的组织
	 */
...
*/		}
	...
	private void initPage() throws Exception {
		this.bean.getOrganizationListbox().setPagePosition("costUnitPage");
		this.bean.getOrganizationRelationListbox().setPagePosition("costUnitPage");
//		this.bean.getStaffOrganizationListbox().setPagePosition("costUnitPage");
//		this.bean.getOrganizationPositionExt().setPagePosition("costUnitPage");
	}
}
