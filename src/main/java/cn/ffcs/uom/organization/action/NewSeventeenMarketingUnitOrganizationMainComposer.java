...
import cn.ffcs.uom.organization.action.bean.NewSeventeenMarketingUnitOrganizationMainBean;
...
@Controller
@Scope("prototype")
public class NewSeventeenMarketingUnitOrganizationMainComposer extends
		BasePortletComposer implements IPortletInfoProvider {

	/**
     * .
     */
    private static final long serialVersionUID = -909381536298639866L;
    /**
	 * bean.
	 */
	private NewSeventeenMarketingUnitOrganizationMainBean bean = new NewSeventeenMarketingUnitOrganizationMainBean();
	/**
	 * 选中的组织
	 */
		...
		if (organization != null && organization.getOrgId() != null) {
			if ("organizationRelationTab".equals(this.bean.getSelectTab()
				...
				this.bean.getOrganizationRelationListbox()
						.setVariablePagePosition("newSeventeenMarketingUnitPage");
