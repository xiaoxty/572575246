...
import cn.ffcs.uom.organization.component.NewMarketingTreeExt;
...
public class NewOrganizationMarketingTreeMainBean {

	@Getter
	@Setter
	private Window newOrganizationMarketingTreeMainWindow;
	/**
	 * tabBox
	 */
	@Getter
	...
	@Getter
	@Setter
	private NewMarketingTreeExt newMarketingTreeExt;
	/**
	 * EDW树
	 */
	@Getter
