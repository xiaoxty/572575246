...
import cn.ffcs.uom.organization.component.MssProfitTreeExt;

public class OrganizationMssProfitTreeMainBean {
    /**
     * tabBox
     */
    @Getter
    ...
    @Getter
    @Setter
    private MssProfitTreeExt mssProfitTreeExt;
