...
import cn.ffcs.uom.organization.action.bean.OrganizationMssProfitTreeMainBean;
...
@Controller
@Scope("prototype")
public class OrganizationTreeMssProfitMainComposer extends BasePortletComposer
     ...
     * 页面bean
     */
    private OrganizationMssProfitTreeMainBean bean = new OrganizationMssProfitTreeMainBean();
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        this.bean.getMssProfitTreeExt().setPortletInfoProvider(this);
        /**
         * 选中组织树上的组织
         */
        this.bean.getMssProfitTreeExt().addForward(
            OrganizationConstant.ON_SELECT_COST_ORGANIZATION_TREE_REQUEST, this.self,
            "onSelectMssProfitTreeResponse");    
    }
...
//        this.bean.getMssProfitTreeExt().setPagePosition("mssCostTreePage");
        /**
         * 组织信息编辑页面只显示营销组织的类型
         */
    ...
    private void initLeftTabControlRightPage() throws Exception {
        String selectedTabId = "profitTab";
    }
    ...
    public void initLeftTab() throws Exception {
        boolean checkCostTabResult = PlatformUtil.checkHasPermission(this, ActionKeys.JTMSS_PROFIT_TAB);
        if (!checkCostTabResult) {
            ...
            this.bean.getMssProfitTab().setSelected(true);
        }
    ...
    public void onSelectMssProfitTreeResponse(ForwardEvent event){
        JtMssProfitRelation jtMssProfitRelation = (JtMssProfitRelation)event.getOrigin().getData();
        String subSetName = jtMssProfitRelation.getSubSetName()== null ? "" : jtMssProfitRelation.getSubSetName();
        String subName = jtMssProfitRelation.getSubName()== null ? "" : jtMssProfitRelation.getSubName();
    ...
    public void callLeftTab() throws Exception {
        ...
        JtMssProfitRelation jtMssProfitRelation = null;
        
        if ("mssProfitTab".equals(bean.getLeftSelectTab().getId())) {
            jtMssProfitRelation = this.bean.getMssProfitTreeExt()
                .getSelectOrganizationOrganization();
            
        }
        if (jtMssProfitRelation != null && jtMssProfitRelation.getSubSetName() != null) {
            ...
            if (org != null) {
                ...
                if ("mssCostTab".equals(bean.getLeftSelectTab().getId())) {
                    ...
                    Events.postEvent(OrganizationConstant.ON_SAVE_ORGANIZATION_INFO,
                        this.bean.getMssProfitTreeExt(), org);
                }
            }
        }
    }
