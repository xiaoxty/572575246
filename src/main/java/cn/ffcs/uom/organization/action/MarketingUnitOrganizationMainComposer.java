...
import cn.ffcs.uom.organization.action.bean.MarketingUnitOrganizationMainBean;
...
@Controller
@Scope("prototype")
public class MarketingUnitOrganizationMainComposer extends BasePortletComposer
	 ...
	 * bean.
	 */
	private MarketingUnitOrganizationMainBean bean = new MarketingUnitOrganizationMainBean();
	/**
	 * 选中的组织
	 */
		...
		if (organization != null && organization.getOrgId() != null) {
			if ("organizationRelationTab".equals(this.bean.getSelectTab()
				...
				this.bean.getOrganizationRelationListbox()
						.setVariablePagePosition("marketingUnitPage");
	...
	private void initPage() throws Exception {
		this.bean.getOrganizationListbox().setPagePosition("marketingUnitPage");
