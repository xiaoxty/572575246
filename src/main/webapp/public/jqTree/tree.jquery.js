  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype.removeNode = function(node) {
      ...
      mustUnselectedNode = function() {
        ...
        if (!_this.selected_node) {
          ...
          //result = true;
		  result=false;//fix by zz
          //iterate(function(child) {
		  node.iterate(function(child) {//fix by zz
            if (node === child) {
              result = true;
              return false;
            } else {
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createLi = function(node) {
        ...
        /*zz add*/
        $li.find("span span").click(function(){
        	$(this).prev()[0].click();
        });
      ...
      createNodeLi = function(node) {
        ...
        var html;
        if(!node.loading&&_this.options.checkbox){
        	var checked=node.checked?"checked":"";
        	var color=node.exclusion?"style='color:#d0d0d0;'":"";
        	html="<li class=\"jqtree_common \"><div>" +
    		"<span class=\"jqtree_common jqtree-title\" ><input nid='"+node.id+"' type='checkbox' "+checked+" ></input>"+
    		"<span "+color+" >" + escaped_name + "</span></span></div></li>";
    	}else
    		html="<li class=\"jqtree_common\"><div><span class=\"jqtree-title jqtree_common\">" + escaped_name + "</span></div></li>";
        return $(html);
        /*end*/
      };
      createFolderLi = function(node) {
        ...
        if(!node.loading&&_this.options.checkbox){
        	var checked=node.checked?"checked":"";
        	var color=node.exclusion?"style='color:#d0d0d0;'":"";
        	html="<li class=\"jqtree_common " + folder_classes + "\"><div><a class=\"jqtree_common " + button_classes + "\">" + button_char + "</a>" +
    		"<span class=\"jqtree_common jqtree-title\" ><input nid='"+node.id+"' type='checkbox' "+checked+" ></input>"+
    		"<span "+color+" >" + escaped_name + "</span></span></div></li>";
    	}else
    		html="<li class=\"jqtree_common " + folder_classes + "\"><div><a class=\"jqtree_common " + button_classes + "\">" + button_char + "</a><span class=\"jqtree_common jqtree-title\">" + escaped_name + "</span></div></li>";
        return $(html);
        /*end*/
      };
